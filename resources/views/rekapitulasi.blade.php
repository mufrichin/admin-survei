...
<div class="row">
  <div class="col-md-4 mb-4">
    <div class="stats-small stats-small--1 card card-small">
      <a class="card-body p-0 d-flex" href="{{url ('rekap/dosen')}}">
  ...
  <div class="col-md-4 mb-4">
    <div class="stats-small stats-small--1 card card-small">
      <a class="card-body p-0 d-flex" href="{{url ('rekap/mahasiswa')}}">
        <div class="d-flex flex-column m-auto">
          <div class="stats-small__data text-center">
  ...
  <div class="col-md-4 mb-4">
    <div class="stats-small stats-small--1 card card-small">
      <a class="card-body p-0 d-flex" href="{{url ('rekap/tendik')}}">
        <div class="d-flex flex-column m-auto">
          <div class="stats-small__data text-center">
  ...
  <div class="col-md-4 mb-4">
    <div class="stats-small stats-small--1 card card-small">
      <a class="card-body p-0 d-flex" href="{{url('rekap/alumni')}}">
        <div class="d-flex flex-column m-auto">
          <div class="stats-small__data text-center">
  ...
  <div class="col-md-4 mb-4">
    <div class="stats-small stats-small--1 card card-small">
      <a class="card-body p-0 d-flex" href="{{url('rekap/pengguna')}}">
        <div class="d-flex flex-column m-auto">
          <div class="stats-small__data text-center">
  ...
  <div class="col-md-4 mb-4">
    <div class="stats-small stats-small--1 card card-small">
      <a class="card-body p-0 d-flex" href="{{url('rekap/mitra')}}">
        <div class="d-flex flex-column m-auto">
          <div class="stats-small__data text-center">
