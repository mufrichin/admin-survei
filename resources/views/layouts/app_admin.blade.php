...
<body>
  ...
  <div id="sidr">
    <!-- Your content -->
    <ul>
      <li><a href="{{url('http://survei.um.ac.id')}}"><img id="main-logo" class="d-inline-block align-center mr-1" style="max-width: 27px;" src="{{asset('images/um_logo.png')}}">  SIPUAS</a></li>
      <li><a href="{{url('/')}}">
      ...
      <li><a href="{{url('/rekapitulasi')}}">
        ...
        <li><a href="{{url('/responden')}}"><i class="fas fa-user"></i> Detail Responden</a></li>
      </ul>
    </div>
