...
<div class="row">
  <div class="col-md-4 mb-4">
    <div class="stats-small stats-small--1 card card-small">
      <a class="card-body p-0 d-flex" href="<?php echo e(url ('rekap/dosen')); ?>">
  ...
  <div class="col-md-4 mb-4">
    <div class="stats-small stats-small--1 card card-small">
      <a class="card-body p-0 d-flex" href="<?php echo e(url ('rekap/mahasiswa')); ?>">
        <div class="d-flex flex-column m-auto">
          <div class="stats-small__data text-center">
  ...
  <div class="col-md-4 mb-4">
    <div class="stats-small stats-small--1 card card-small">
      <a class="card-body p-0 d-flex" href="<?php echo e(url ('rekap/tendik')); ?>">
        <div class="d-flex flex-column m-auto">
          <div class="stats-small__data text-center">
  ...
  <div class="col-md-4 mb-4">
    <div class="stats-small stats-small--1 card card-small">
      <a class="card-body p-0 d-flex" href="<?php echo e(url('rekap/alumni')); ?>">
        <div class="d-flex flex-column m-auto">
          <div class="stats-small__data text-center">
  ...
  <div class="col-md-4 mb-4">
    <div class="stats-small stats-small--1 card card-small">
      <a class="card-body p-0 d-flex" href="<?php echo e(url('rekap/pengguna')); ?>">
        <div class="d-flex flex-column m-auto">
          <div class="stats-small__data text-center">
  ...
  <div class="col-md-4 mb-4">
    <div class="stats-small stats-small--1 card card-small">
      <a class="card-body p-0 d-flex" href="<?php echo e(url('rekap/mitra')); ?>">
        <div class="d-flex flex-column m-auto">
          <div class="stats-small__data text-center">
